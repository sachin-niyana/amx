...
const Header = () => {
  return (
    <div className="bg-header-bg bg-cover">
      <Navbar />
      <div className="container max-w-[1152px] mx-auto px-3 lg:pt-[122px] pt-24 lg:pb-20 md:pb-16 sm:pb-14 pb-12">
        ...
        <div className="flex sm:flex-row flex-col flex-wrap mt-2">
          <div className="md:w-6/12 w-5/12"></div>
          <div className="md:w-6/12 sm:w-7/12">
            <div className="flex items-center">
              <div className="w-[2px] bg-dark-gray h-[106px]"></div>
              <p className="text-light-gray font-Inter font-normal ps-[25px] sm:text-sm text-xsm max-w-[357px] w-full leading-[150%]">
